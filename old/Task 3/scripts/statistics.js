...
function loadStatistics(members){
    ...
    for(let i=0;i<members.length;i++){
        ...
        (statistics.ptgVotesDem==0&&statistics.dem!=0)? divWoNull++ :null;
        (statistics.ptgVotesInd==0&&statistics.ind!=0)? divWoNull++ :null;
        (statistics.ptgVotesRep==0&&statistics.rep!=0)? divWoNull++ :null;
